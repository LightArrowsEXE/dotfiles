Dotfiles I use for my new Arch Linux installation (as well as on my Windows setup for some of them, ie mpv). You are free to use them as a reference or use them as-is.
